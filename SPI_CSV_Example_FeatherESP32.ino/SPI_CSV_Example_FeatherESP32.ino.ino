...
void setup() {
  ...
  //musicPlayer.sineTest(0x44, 500);    // (if uncommented) Make a tone to indicate VS1053 is working
...
#endif
File LIST;                                                               // Create a new file object
  LIST = SD.open("/LIST.csv");                                           // Open the file. The slash is necessary, look at the serial monitor
  ...
  musicPlayer.playFullFile("/Beethoven__Fur_Elise_Full_Track.mp3");      //specify file to play
